...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int i) {
        ...
        viewHolder.usernamesearch.setText(user.getUsername());
        viewHolder.fullnamesearch.setText(user.getFullname());
        viewHolder.regnosearch.setText(user.getUserreg());
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SharedPreferences.Editor editor1 = mContext.getSharedPreferences("PREFS",Context.MODE_PRIVATE).edit();
                editor1.putString("profileid",user.getId());
                editor1.apply();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView fullnamesearch;
        public TextView regnosearch;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            fullnamesearch =itemView.findViewById(R.id.fullnamesearch);
            regnosearch = itemView.findViewById(R.id.regnosearch);
